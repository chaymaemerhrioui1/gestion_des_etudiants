...
def club_data_page():
    ...
    lb4 = tk.Label(club_data_frame,
                   text='Membres du Data Club ! explorer les données de manière ludique et engageante\n'
...
def club_genie_civil_page():
    ...
    lb2 = tk.Label(club_genie_civil_frame,
                   text='aider les membres à améliorer leurs compétences techniques, leur compréhension \n'
...
def Club_01_page():
    ...
    lb = tk.Label(Club_01_frame,
                  text='aider les membres à développer leurs compétences scientifiques et technologiques \n'
...
club_data_btn = tk.Button(options_frame, text='Club Data ', font=('Bold', 15), fg='white', bd=0, bg='#12c4c0',
                          command=lambda: indicate(club_data_indicate, club_data_page))
...
club_genie_civil_btn = tk.Button(options_frame, text='Club Génie civil', font=('Bold', 15), fg='white', bd=0,
                                 bg='#12c4c0',
                                 command=lambda: indicate(club_genie_civil_indicate, club_genie_civil_page))
...
club_cct_btn = tk.Button(options_frame, text='Club CCT', font=('Bold', 15), fg='white', bd=0, bg='#12c4c0',
                         command=lambda: indicate(club_cct_indicate, club_cct_page))
...
Club_01_btn = tk.Button(options_frame, text='Club 01', font=('Bold', 15), fg='white', bd=0, bg='#12c4c0',
                        command=lambda: indicate(Club_01_indicate, Club_01_page))
...
loginButton = Button(options_frame, text='Retour', font=('Open Sans', '9', 'bold underline'), bg='white', fg='#12c4c0',
                     bd=0, cursor='hand2', activebackground='white', activeforeground='blue',
                     command=login_page)
